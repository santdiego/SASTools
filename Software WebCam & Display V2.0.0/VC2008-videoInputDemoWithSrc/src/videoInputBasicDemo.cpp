...
int main( void )
{
	...
	if (!glfwOpenWindow(ANCHO_IMAGEN*2,ALTO_IMAGEN,     // Open window
    ...
    while( running ){
        ...
        if( (t-t0) > 1.0 || frames == 0 )
        {
            ...
            sprintf( titlestr, "SAS video App (%.1f FPS) - Original = %d [bytes] -> Comprimida = %d [bytes]", fps, orgSize, compSize );
