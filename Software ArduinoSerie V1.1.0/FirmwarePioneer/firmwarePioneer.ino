          ...
          bool band_tx=0,band_control=0,band_rx=0,signo[2];    //banderas de control y de transmision
         ...
         ///////// velocidad rueda izquierda ///////////// 
           ...
           ////////////// accion de control lineal ///////////     
            ...
            if(band_rx==1){
                        ...
                        // rv=(float)256.00*(0x3F & inData1[2])+inData1[1];   //referencia de velocidad lineal byte a float  
                          rv=(float)256.00*(0x7F & inData1[4])+inData1[3]; 
                         //rw=(float)256.00*(0x3F & inData1[4])+inData1[3];   // de 14 bits + 1 signo  DEBUG
                          rw=(float)256.00*(0x7F & inData1[6])+inData1[5]; 
                       
                        //if((inData1[2]& 0x40)>0){                // verifica signo en bit 15  DEBUG
                        if((inData1[4]& 0x80)>0){ 
                            signo[0]=1;
                            rv=rv*(-1.00);
                        }else{
                        ...
                        //if((inData1[4]& 0x40)>0){                // verifica signo velocidad angular en bit 15 DEBUG
                        if((inData1[6]& 0x80)>0){
                            signo[1]=1;
                            rw=rw*(-1.0);
                        }else{
